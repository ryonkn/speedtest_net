...
module SpeedtestNet
  class Server
    ...
    class << self
      ...
      def fetch_servers
        client = Typhoeus::Request.new('https://www.speedtest.net/speedtest-servers.php', followlocation: true)
        client.run

        raise HTTPDownloadError, 'Server lists download error' if client.response.code != 200
