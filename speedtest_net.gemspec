...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Ruby Library for testing internet bandwidth using speedtest.net}
  spec.description   = %q{Ruby Library for testing internet bandwidth using speedtest.net}
